...
public class SellerDaoJDBC  implements SellerDao {
    ...
    public Seller findById(Integer id) {
        ...
        ResultSet rs = null;
        String column = "DepartmentName";

        try {
            st = conn.prepareStatement("SELECT seller.*,department.Name as " +
                    column +
                    " " +
            ...
            rs = st.executeQuery();
            if (rs.next()) {
                Department dep = intantiateDepartment(rs, column);
    ...
    private static Department intantiateDepartment(ResultSet rs, String column) throws SQLException {
        Department dep = new Department();
        dep.setId(rs.getInt("DepartmentId"));
        dep.setName(rs.getString(column));
        return dep;
    }
